...
<head>
    ...
    <title>{{subject}}</title>
    <style>
        body { font-family: Georgia, serif; line-height: 1.8; color: #222; background: #f5f5f5; margin: 0; padding: 20px; }
        .container { max-width: 600px; margin: 0 auto; background: #fff; }
        .header { background: #2c3e50; color: #fff; padding: 40px 30px; text-align: center; }
        ...
        .footer { background: #ecf0f1; padding: 20px 30px; text-align: center; font-size: 12px; color: #7f8c8d; }
    </style>
</head>
<body>
    <div class="container">
...
<head>
    ...
    <title>{{subject}}</title>
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #2d3748; background: #f7fafc; margin: 0; padding: 40px 20px; }
        .container { max-width: 600px; margin: 0 auto; }
        .card { background: #fff; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); overflow: hidden; }
        .card-header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; padding: 40px 30px; }
        .card-header h1 { margin: 0; font-size: 26px; font-weight: 600; }
        .card-body { padding: 40px 30px; }
        .card-body h2 { color: #4a5568; font-size: 20px; margin-top: 0; }
        .card-footer { padding: 20px 30px; text-align: center; font-size: 12px; color: #a0aec0; border-top: 1px solid #e2e8f0; }
    </style>
</head>
<body>
    <div class="container">
...
<head>
    ...
    <title>{{subject}}</title>
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.7; color: #333; background: #fff; margin: 0; padding: 0; }
        .container { max-width: 600px; margin: 0 auto; border-left: 4px solid #e74c3c; }
        .header { padding: 30px; border-bottom: 1px solid #eee; }
        .header h1 { margin: 0; font-size: 24px; color: #2c3e50; }
        .content { padding: 30px; }
        .content h2 { font-size: 20px; color: #34495e; margin-top: 0; }
        .footer { padding: 20px 30px; border-top: 1px solid #eee; font-size: 12px; color: #7f8c8d; }
    </style>
</head>
<body>
    <div class="container">
