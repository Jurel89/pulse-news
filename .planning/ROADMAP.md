...
- [ ] **Phase 1: Foundation and Secure Control Plane** - Build the authenticated app shell and core newsletter management domain.
- [ ] **Phase 2: Draft Workflow and Template System** - Add recipient management, themed templates, previews, and test sends.
...
|-------|----------------|--------|-----------|
| 1. Foundation and Secure Control Plane | 0/3 | Not started | - |
| 2. Draft Workflow and Template System | 0/3 | Not started | - |
